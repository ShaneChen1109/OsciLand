...
% plot(Z);
step = 20;
% quiver(circle_proj(1:step:length(circle_proj),3),circle_proj(1:step:length(circle_proj),5), ...
%     flux(1:step:length(circle_proj),3),flux(1:step:length(circle_proj),5))
